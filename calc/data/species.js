...
var ROMHACK_PATCH = {
    ...
    Jigglypuff: {
        types: ['Normal'],
        bs: { hp: 115, at: 45, df: 40, sa: 45, sd: 45, sp: 20 },
        weightkg: 5.5,
        abilities: { 0: 'Cute Charm' }
    },
    Wigglytuff: {
        types: ['Normal'],
        bs: { hp: 140, at: 70, df: 65, sa: 85, sd: 70, sp: 45 },
        weightkg: 12,
        abilities: { 0: 'Cute Charm' }
    },
    Zubat: {
    ...
    Accelgor: {
        types: ['Bug'],
        bs: { hp: 80, at: 90, df: 40, sa: 100, sd: 60, sp: 145 },
        weightkg: 25.3,
        abilities: { 0: 'Unburden' }
    },
    Grimer: {
    ...
    'Mr. Mime': {
        types: ['Psychic'],
        bs: { hp: 80, at: 45, df: 65, sa: 100, sd: 120, sp: 90 },
        weightkg: 54.5,
    ...
    Ditto: {
        types: ['Normal'],
        bs: { hp: 48, at: 48, df: 48, sa: 48, sd: 48, sp: 148 },
        weightkg: 4,
        abilities: { 0: 'Magic Guard' }
    },
    Eevee: {
    ...
    Noctowl: {
        types: ['Psychic', 'Flying'],
        bs: { hp: 100, at: 50, df: 60, sa: 86, sd: 106, sp: 70 },
        weightkg: 40.8,
        abilities: { 0: 'Insomnia' }
    },
    Ledyba: {
    ...
    Ledian: {
        types: ['Bug', 'Fighting'],
        bs: { hp: 55, at: 135, df: 50, sa: 55, sd: 110, sp: 85 },
        weightkg: 35.6,
        abilities: { 0: 'Skill Link' }
    },
    Spinarak: {
    ...
    Ariados: {
        types: ['Bug', 'Poison'],
        bs: { hp: 70, at: 90, df: 70, sa: 60, sd: 70, sp: 120 },
        weightkg: 33.5,
        abilities: { 0: 'Swarm' }
    },
    Crobat: {
    ...
    Sudowoodo: {
        types: ['Rock'],
        bs: { hp: 70, at: 100, df: 115, sa: 30, sd: 95, sp: 30 },
        weightkg: 38,
    ...
    Quagsire: {
        types: ['Water', 'Ground'],
        bs: { hp: 95, at: 85, df: 85, sa: 85, sd: 65, sp: 35 },
        weightkg: 75,
        abilities: { 0: 'Unaware' }
    },
    Espeon: {
    ...
    Unown: {
        types: ['Psychic'],
        bs: { hp: 48, at: 72, df: 48, sa: 100, sd: 48, sp: 100 },
        weightkg: 5,
        abilities: { 0: 'Levitate' }
    },
    Wobbuffet: {
    ...
    Mightyena: {
        types: ['Dark', 'Normal'],
        bs: { hp: 70, at: 115, df: 70, sa: 60, sd: 60, sp: 80 },
        weightkg: 37,
        abilities: { 0: 'Intimidate' }
    },
    Litleo: {
    ...
    Swellow: {
        types: ['Normal', 'Flying'],
        bs: { hp: 60, at: 85, df: 60, sa: 95, sd: 50, sp: 125 },
        weightkg: 19.8,
        abilities: { 0: 'Guts' }
    },
    Wingull: {
    ...
    Pelipper: {
        types: ['Water', 'Flying'],
        bs: { hp: 90, at: 50, df: 100, sa: 95, sd: 70, sp: 65 },
        weightkg: 28,
        abilities: { 0: 'Rain Dish' }
    },
    Ralts: {
    ...
    Masquerain: {
        types: ['Bug', 'Flying'],
        bs: { hp: 70, at: 60, df: 82, sa: 100, sd: 82, sp: 90 },
        weightkg: 3.6,
        abilities: { 0: 'Intimidate' }
    },
    Shroomish: {
    ...
    Shedinja: {
        types: ['Bug', 'Ghost'],
        bs: { hp: 1, at: 90, df: 45, sa: 90, sd: 30, sp: 40 },
        weightkg: 1.2,
        abilities: { 0: 'Wonder Guard' }
    },
    Rowlet: {
    ...
    Sableye: {
        types: ['Dark', 'Ghost'],
        bs: { hp: 110, at: 75, df: 75, sa: 65, sd: 65, sp: 50 },
        weightkg: 11,
        abilities: { 0: 'Keen Eye' }
    },
    Mawile: {
        types: ['Steel', 'Fire'],
        bs: { hp: 50, at: 85, df: 85, sa: 55, sd: 55, sp: 90 },
        weightkg: 11.5,
        abilities: { 0: 'Flash Fire' }
    },
    Aron: {
    ...
    Swalot: {
        types: ['Poison'],
        bs: { hp: 100, at: 73, df: 93, sa: 73, sd: 93, sp: 55 },
        weightkg: 80,
        abilities: { 0: 'Magic Guard' }
    },
    Carvanha: {
    ...
    Sharpedo: {
        types: ['Water', 'Dark'],
        bs: { hp: 70, at: 120, df: 60, sa: 95, sd: 40, sp: 95 },
        weightkg: 88.8,
        abilities: { 0: 'Rough Skin' }
    },
    Wailmer: {
    ...
    Camerupt: {
        types: ['Fire', 'Ground'],
        bs: { hp: 70, at: 100, df: 70, sa: 105, sd: 95, sp: 40 },
        weightkg: 220,
        abilities: { 0: 'Simple' }
    },
    Torkoal: {
    ...
    Frosmoth: {
        types: ['Ice', 'Bug'],
        bs: { hp: 70, at: 65, df: 60, sa: 125, sd: 120, sp: 65 },
        weightkg: 42,
        abilities: { 0: 'Shield Dust' }
    },
    Sizzlipede: {
    ...
    Whiscash: {
        types: ['Water', 'Ground'],
        bs: { hp: 110, at: 78, df: 73, sa: 76, sd: 71, sp: 75 },
        weightkg: 23.6,
        abilities: { 0: 'Oblivious' }
    },
    Corphish: {
    ...
    Banette: {
        types: ['Ghost'],
        bs: { hp: 64, at: 115, df: 65, sa: 115, sd: 63, sp: 65 },
        weightkg: 12.5,
        abilities: { 0: 'Immunity' }
    },
    Duskull: {
    ...
    Dusclops: {
        types: ['Ghost'],
        bs: { hp: 60, at: 70, df: 130, sa: 60, sd: 130, sp: 25 },
        weightkg: 30.6,
        abilities: { 0: 'Levitate' }
    },
    Tropius: {
        types: ['Grass', 'Flying'],
        bs: { hp: 99, at: 90, df: 83, sa: 90, sd: 87, sp: 51 },
        weightkg: 100,
        abilities: { 0: 'Thick Fat' }
    },
    Chimecho: {
        types: ['Psychic'],
        bs: { hp: 75, at: 50, df: 90, sa: 95, sd: 110, sp: 65 },
        weightkg: 1,
        abilities: { 0: 'Levitate' }
    },
    Absol: {
        types: ['Dark'],
        bs: { hp: 65, at: 130, df: 60, sa: 75, sd: 60, sp: 85 },
        weightkg: 47,
        abilities: { 0: 'Guts' }
    },
    Wynaut: {
    ...
    Bibarel: {
        types: ['Normal', 'Water'],
        bs: { hp: 140, at: 85, df: 60, sa: 55, sd: 60, sp: 71 },
        weightkg: 31.5,
        abilities: { 0: 'Simple' }
    },
    Kricketot: {
    ...
    Kricketune: {
        types: ['Bug'],
        bs: { hp: 100, at: 115, df: 65, sa: 55, sd: 65, sp: 74 },
        weightkg: 25.5,
        abilities: { 0: 'Swarm' }
    },
    Shinx: {
    ...
    Vespiquen: {
        types: ['Bug', 'Flying'],
        bs: { hp: 70, at: 80, df: 102, sa: 80, sd: 102, sp: 100 },
        weightkg: 38.5,
        abilities: { 0: 'Technician' }
    },
    Pachirisu: {
        types: ['Electric'],
        bs: { hp: 60, at: 60, df: 70, sa: 60, sd: 90, sp: 135 },
        weightkg: 3.9,
        abilities: { 0: 'Volt Absorb' }
    },
    Buizel: {
    ...
    Cherrim: {
        types: ['Grass'],
        bs: { hp: 70, at: 60, df: 70, sa: 117, sd: 78, sp: 85 },
        weightkg: 9.3,
        abilities: { 0: 'Flower Gift' }
    },
    Shellos: {
    ...
    Purugly: {
        types: ['Normal'],
        bs: { hp: 89, at: 82, df: 64, sa: 64, sd: 59, sp: 112 },
        weightkg: 43.8,
        abilities: { 0: 'Thick Fat' }
    },
    Chingling: {
    ...
    Chatot: {
        types: ['Normal', 'Flying'],
        bs: { hp: 76, at: 65, df: 65, sa: 92, sd: 62, sp: 91 },
        weightkg: 1.9,
        abilities: { 0: 'Keen Eye' }
    },
    Spiritomb: {
    ...
    Carnivine: {
        types: ['Grass'],
        bs: { hp: 74, at: 130, df: 72, sa: 120, sd: 72, sp: 46 },
        weightkg: 27,
        abilities: { 0: 'Levitate' }
    },
    Finneon: {
    ...
    Lumineon: {
        types: ['Water'],
        bs: { hp: 69, at: 83, df: 76, sa: 83, sd: 86, sp: 91 },
        weightkg: 24,
        abilities: { 0: 'Swift Swim' }
    },
    Mantyke: {
...
var DPP = (0, util_1.extend)(true, {}, ADV, DPP_PATCH, ROMHACK_PATCH);
var BW_PATCH = {
